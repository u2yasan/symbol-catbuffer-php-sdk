...
final class TransferTransactionV3 {
    public const SIZE = 151;             // 148 + messageSize(2) + mosaicsCount(1)
    ...
    public function __construct(
        ...
        public int $version,             // u8 (必ず 3)
        public int $network,             // u8
        public int $type,                // u16le (0x4154)
        public int $maxFee,              // u64le
        public int $deadline,            // u64le (epoch基準ms)
        public string $recipientRaw24,   // 24B
        public int $messageSize,         // u16le
        public int $mosaicsCount,        // u8
